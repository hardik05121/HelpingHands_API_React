...
namespace HelpingHands_API.Controllers.v1
{
    ...
    public class SecondCategoryAPIController : ControllerBase
    {
        ...
        public SecondCategoryAPIController(IUnitOfWork unitOfWork, IMapper mapper,ApplicationDbContext db)
        {
        ...
        public async Task<ActionResult<APIResponse>> CreateSecondCategory([FromForm] SecondCategoryCreateDTO createDTO)
        {
        ...
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<APIResponse>> UpdateSecondCategory(int id, [FromForm] SecondCategoryUpdateDTO updateDTO)
        {
            try
            {
