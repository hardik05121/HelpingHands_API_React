...
namespace HelpingHands_API.Controllers.v1
{
    ...
    public class FirstCategoryAPIController : ControllerBase
    {
       ...
       // [Authorize(Roles = "admin")]
        ...
        public async Task<ActionResult<APIResponse>> CreateFirstCategory([FromForm] FirstCategoryCreateDTO createDTO)
        {
      ...
      //  [Authorize(Roles = "admin")]
        ...
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<APIResponse>> UpdateFirstCategory(int id, [FromForm] FirstCategoryUpdateDTO updateDTO)
        {
            try
            {
